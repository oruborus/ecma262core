...
interface BindingPropertyParser
{
    /**
     * @see https://tc39.es/ecma262/#prod-BindingProperty
     *
     * @throws ThrowCompletion
     */
    public function parse(SourceCode $sourceCode, Position $position, Parameters $parameters): ?BindingProperty;
}
