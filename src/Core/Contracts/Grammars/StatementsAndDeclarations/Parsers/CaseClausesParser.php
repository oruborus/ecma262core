...
interface CaseClausesParser
{
    /**
     * @see https://tc39.es/ecma262/#prod-CaseClauses
     *
     * @throws ThrowCompletion
     */
    public function parse(SourceCode $sourceCode, Position $position, Parameters $parameters): ?CaseClauses;
}
