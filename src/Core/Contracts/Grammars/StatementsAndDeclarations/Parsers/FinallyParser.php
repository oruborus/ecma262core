...
interface FinallyParser
{
    /**
     * @see https://tc39.es/ecma262/#prod-Finally
     *
     * @throws ThrowCompletion
     */
    public function parse(SourceCode $sourceCode, Position $position, Parameters $parameters): ?Finally_;
}
