...
interface RelationalExpressionParser
{
     ...
     */
    public function parse(Lexer $lexer, Parameters $parameters): ?RelationalExpression;
     ...
     * @throws ThrowCompletion
     */
    public function parseOrFail(Lexer $lexer, Parameters $parameters): RelationalExpression;
}
