...
interface IdentifierReferenceParser
{
     ...
     */
    public function parse(Lexer $lexer, Parameters $parameters): ?IdentifierReference;
     ...
     * @throws ThrowCompletion
     */
    public function parseOrFail(Lexer $lexer, Parameters $parameters): IdentifierReference;
}
