...
interface LogicalAndExpressionParser
{
     ...
     */
    public function parse(Lexer $lexer, Parameters $parameters): ?LogicalAndExpression;
     ...
     * @throws ThrowCompletion
     */
    public function parseOrFail(Lexer $lexer, Parameters $parameters): LogicalAndExpression;
}
