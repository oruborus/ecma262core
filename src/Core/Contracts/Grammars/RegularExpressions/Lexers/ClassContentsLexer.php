...
interface ClassContentsLexer
{
     ...
     */
    public function parse(Agent $agent, Lexer $lexer, Parameters $parameters): ?ClassContents;

    /**
     * @see https://tc39.es/ecma262/#prod-ClassContents
     *
     * @throws ThrowCompletion
     */
    public function parseOrFail(Agent $agent, Lexer $lexer, Parameters $parameters): ClassContents;
}
