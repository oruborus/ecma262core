...
interface CharacterEscapeLexer
{
    /**
     * @see https://tc39.es/ecma262/#prod-CharacterEscape
     *
     * @throws ThrowCompletion
     */
    public function parse(Agent $agent, Lexer $lexer, Parameters $parameters): ?CharacterEscape;
}
