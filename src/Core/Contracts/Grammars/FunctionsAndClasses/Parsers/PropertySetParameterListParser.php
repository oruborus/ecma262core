...
interface PropertySetParameterListParser
{
     ...
     */
    public function parse(Lexer $lexer, Parameters $parameters): ?PropertySetParameterList;
     ...
     */
    public function parseOrFail(Lexer $lexer, Parameters $parameters): PropertySetParameterList;
}
