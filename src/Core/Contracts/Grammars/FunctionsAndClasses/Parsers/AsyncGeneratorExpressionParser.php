...
interface AsyncGeneratorExpressionParser
{
     ...
     */
    public function parse(Agent $agent, Lexer $lexer, Parameters $parameters): ?AsyncGeneratorExpression;
     ...
     * @throws ThrowCompletion
     */
    public function parseOrFail(Agent $agent, Lexer $lexer, Parameters $parameters): AsyncGeneratorExpression;
}
