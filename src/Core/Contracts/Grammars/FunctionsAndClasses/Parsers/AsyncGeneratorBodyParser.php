...
interface AsyncGeneratorBodyParser
{
     ...
     */
    public function parse(Lexer $lexer, Parameters $parameters): ?AsyncGeneratorBody;
     ...
     * @throws ThrowCompletion
     */
    public function parseOrFail(Lexer $lexer, Parameters $parameters): AsyncGeneratorBody;
}
