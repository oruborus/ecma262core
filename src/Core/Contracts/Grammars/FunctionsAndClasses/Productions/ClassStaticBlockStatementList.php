...
interface ClassStaticBlockStatementList extends ClassStaticBlockBody
{
    /**
    ...
    /** @see https://tc39.es/ecma262/#sec-static-semantics-containsarguments */
    public function containsArguments(): BooleanValue;
}
