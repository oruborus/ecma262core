...
interface AsyncGeneratorExpression extends PrimaryExpression
{
    ...
    /** @see https://tc39.es/ecma262/#sec-runtime-semantics-instantiateasyncgeneratorfunctionexpression */
    public function instantiateAsyncGeneratorFunctionExpression(null|StringValue|SymbolValue|PrivateName $name = null): ObjectValue;
}
