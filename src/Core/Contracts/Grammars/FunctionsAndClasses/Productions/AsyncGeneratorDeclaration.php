...
{
    /** @see https://tc39.es/ecma262/#sec-runtime-semantics-instantiateasyncgeneratorfunctionobject */
    public function instantiateAsyncGeneratorFunctionObject(EnvironmentRecord $env, NullValue|PrivateEnvironmentRecord $privateEnv): ObjectValue;
}
