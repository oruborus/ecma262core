...
interface BindingElementParser
{
     ...
     */
    public function parse(Agent $agent, Lexer $lexer, Parameters $parameters): ?BindingElement;
     ...
     * @throws ThrowCompletion
     */
    public function parseOrFail(Agent $agent, Lexer $lexer, Parameters $parameters): BindingElement;
}
