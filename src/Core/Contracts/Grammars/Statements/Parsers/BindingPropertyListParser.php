...
interface BindingPropertyListParser
{
     ...
     */
    public function parse(Agent $agent, Lexer $lexer, Parameters $parameters): ?BindingPropertyList;
     ...
     * @throws ThrowCompletion
     */
    public function parseOrFail(Agent $agent, Lexer $lexer, Parameters $parameters): BindingPropertyList;
}
