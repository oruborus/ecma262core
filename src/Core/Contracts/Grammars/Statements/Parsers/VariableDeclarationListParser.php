...
interface VariableDeclarationListParser
{
     ...
     */
    public function parse(Lexer $lexer, Parameters $parameters): ?VariableDeclarationList;
     ...
     * @throws ThrowCompletion
     */
    public function parseOrFail(Lexer $lexer, Parameters $parameters): VariableDeclarationList;
}
