...
use Oru\EcmaScript\Core\Contracts\Grammars\Statements\Productions\WithStatement;

interface WithStatementFactory
{
    public function create(Expression $expression, Statement $statement): WithStatement;
}
