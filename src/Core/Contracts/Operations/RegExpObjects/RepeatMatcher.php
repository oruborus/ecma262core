...
interface RepeatMatcher
{
     ...
     */
    public function __invoke(Agent $agent, Matcher $m, NumberValue $min, NumberValue $max, BooleanValue $greedy, MatchState $x, MatcherContinuation $c, int $parenIndex, int $parenCount): MatchState|Failure;
}
