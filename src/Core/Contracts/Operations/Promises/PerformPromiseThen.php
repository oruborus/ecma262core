...
interface PerformPromiseThen
{
     ...
     */
    public function __invoke(ObjectValue $promise, LanguageValue $onFulfilled, LanguageValue $onRejected, ?PromiseCapabilityRecord $resultCapability = null): LanguageValue;
}
